...
public static class Strings
{
    ...
    private static readonly Dictionary<string, (string En, string Es)> Map = new()
    {
        ...
        ["ProcessProperties"] = ("Process properties", "Propiedades del proceso"),
        ["FileInformation"] = ("File information", "Información del archivo"),
        ["Runtime"] = ("Runtime", "Ejecución"),
        ["FriendlyName"] = ("Friendly name", "Nombre descriptivo"),
        ["ImageName"] = ("Image name", "Nombre de imagen"),
        ["Pid"] = ("PID", "PID"),
        ["Cpu"] = ("CPU", "CPU"),
        ["Ram"] = ("RAM", "RAM"),
        ...
        ["OriginalFilename"] = ("Original filename", "Nombre de archivo original"),
        ["ParentProcess"] = ("Parent PID", "PID padre"),
        ["StartTime"] = ("Start time", "Hora de inicio"),
        ["WindowTitle"] = ("Window title", "Título de ventana"),
        ...
        ["GroupedProcessesTip"] = ("Grouped view: {0} applications ({1} total processes)\nLast refresh: {2}", "Vista agrupada: {0} aplicaciones ({1} procesos totales)\nÚltima actualización: {2}"),
        ["NormalProcessesTip"] = ("{0} active system processes\nLast refresh: {1}", "{0} procesos activos en el sistema\nÚltima actualización: {1}"),
        ["ProcessesFilterTip"] = ("Showing {0} matches out of {1} total processes\nLast refresh: {2}", "Mostrando {0} coincidencias de {1} procesos totales\nÚltima actualización: {2}"),
        ["CpuTotal"] = ("CPU {0:F1}%", "CPU {0:F1}%"),
        ["MemTotal"] = ("RAM {0:F1} GB", "RAM {0:F1} GB"),
        ["CpuModel"] = ("CPU model", "Modelo de CPU"),
        ["TotalRam"] = ("Total RAM: {0:F1} GB", "RAM total: {0:F1} GB"),
        ...
        ["DoNotShowAgain"] = ("Don't show again", "No mostrar de nuevo"),
        ["Close"] = ("Close", "Cerrar"),
        ...
        ["AboutCyberManager"] = ("About CyberManager...", "Acerca de CyberManager..."),
        ...
        ["NavSettings"] = ("Settings", "Configuración"),
        ...
        ["NavSettingsTip"] = ("Settings & Preferences (Ctrl+3 / Ctrl+,)", "Configuración y preferencias (Ctrl+3 / Ctrl+,)"),
        ...
        ["MinimizeToTrayOnMinimizeTitle"] = ("Send to notification area when minimizing", "Enviar a la bandeja al minimizar"),
        ["MinimizeToTrayOnMinimizeDesc"] = ("On: hiding the window removes its taskbar button and keeps it available from the notification area. Off: the taskbar button remains visible.", "Activado: al minimizar, desaparece de la barra de tareas y queda disponible en la bandeja. Desactivado: conserva su botón en la barra de tareas."),
        ["MinimizeToTrayOnCloseTitle"] = ("Send to notification area when closing", "Enviar a la bandeja al cerrar"),
        ["MinimizeToTrayOnCloseDesc"] = ("On: closing the window keeps CyberManager running in the notification area. Off: the application exits completely.", "Activado: al cerrar la ventana, CyberManager sigue activo en la bandeja. Desactivado: la aplicación se cierra completamente."),
        ...
        ["GlobalHotkeyDesc"] = ("Click the field and press a modifier combination plus a key. It updates and works immediately.", "Haz clic en el campo y pulsa una combinación de modificadores y una tecla. Se actualiza y funciona al instante."),
        ["GlobalHotkeyCaptureHint"] = ("Press modifiers + key.", "Pulsa modificadores + tecla."),
        ["GlobalHotkeyReset"] = ("Restore shortcut", "Restaurar atajo"),
        ["GlobalHotkeyClear"] = ("Clear shortcut", "Limpiar atajo"),
        ["ResetDefaults"] = ("Reset Defaults", "Restablecer"),
        ["RestoreFactorySettings"] = ("Restore factory settings", "Restaurar ajustes de fábrica"),
